...
namespace HezEngine
{
	...
	void Window::Init(const WindowData& pData)
	{
		...
		HEZ_CORE_INFO("Creating window {0} ({1}, {2})", m_Data.Title, m_Data.Width, m_Data.Height);

		success = glfwInit();
		HEZ_CORE_ASSERT(success, "Failed to initialize GLFW!");
		...
		HEZ_CORE_ASSERT(success, "Failed to initialize Glad!");
